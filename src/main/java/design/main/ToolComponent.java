...
public class ToolComponent extends mxGraphComponent {
	...
	public ToolComponent() {
		...
		try {
			// Simple blocks
			Object va = graph.insertVertex(root, null, "ValueActivity", 20, 20, 120, 120, "ValueActivity");
			Object ac = graph.insertVertex(root, null, "Actor", 20, 160, 120, 120, "Actor");
			Object ms = graph.insertVertex(root, null, "Market Segment", 20, 300, 120, 120, "MarketSegment");
			
			// Value Interface
			mxICell vi = (mxICell) graph.insertVertex(root, null, "", 20, 440, 20, 50, "ValueInterface");
