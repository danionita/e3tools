...
public class RDFExport {
    ...
    public enum VTMode {
        /**
         * Derives all value transactions naively, disregarding any value
         ...
         * DEFAULT
         *
         * Only derives value transactions for value exchanges that have no
         * value transactions. Merges the derived value transactions with the
         * value transactions specified by the user.
         */
        DERIVE_ORPHANED,
        /**
        ...
        /**
         * Ensures that the exported RDF model contains no trace of value
     ...
     *
     * @param graph The graph to convert and merged actors and market segments
     * will be converted from strings to ints and added.
     * @param unsafe Assumes that every field from the graph is a number and can
     * be added
     * @param vtMode Describes how value transactions should be handled.
     * @param castMarketSegments Specifies if a market segment should be cast to
     * an actor.
     */
    ...
    /**
     * Returns the resource corresponding to the SUID in the cell's value stored
     * in the graph.
     *
     * @param cell
     * @return
